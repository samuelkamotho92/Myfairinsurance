...
The issue of this form should not to be taken as an admission
 of Liablity</p>
<p 
style={{textAlign:'center',textTransform:'uppercase',margin:"20px auto"}}>
<em>
In no case admit your fault or make any or offer payment without 
any written authority of the company
